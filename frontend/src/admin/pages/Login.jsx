...
export default function Login() {
  ...
  useEffect(() => {
    ...
    if (params.get('success') === 'true') {
      ...
      try { alert('Login successful'); } catch(_e){}
      window.history.replaceState({}, '', window.location.pathname);
    }
    if (params.get('error')) {
      const err = params.get('error');
      const msg = err.includes('google') ? 'Google authentication failed' : 'Authentication failed';
      setMessage(msg);
  ...
  async function onSubmit(e) {
    ...
    try {
      ...
      // Optional remember me can be used for future token storage strategy
      if (rememberMe) localStorage.setItem('rememberAdmin', '1'); else localStorage.removeItem('rememberAdmin');
      try { alert('Login successful'); } catch(_e){}
      ...
      <div className="flex w-full max-w-6xl mx-4 bg-white rounded-3xl shadow-2xl overflow-hidden relative z-10 animate-fadeIn">
        ...
        >
          ...
          <div className="relative z-10">
            ...
            <p className="text-2xl text-white font-semibold mb-6">Admin Dashboard Portal</p>
        ...
        <div className="w-full lg:w-1/2 p-12 flex flex-col justify-center relative" style={{ background: 'linear-gradient(135deg, #F8FAFF 0%, #FFFFFF 100%)' }}>
          {/* Decorative circle on form side */}
          ...
          <div className="relative z-10 max-w-md mx-auto w-full">
            ...
            <div className="space-y-5">
              ...
              <div className="group">
                ...
                <div className="relative">
                  <div className="absolute inset-y-0 left-0 pl-4 flex items-center pointer-events-none">
                    <svg className="h-5 w-5 text-gray-400 group-focus-within:text-blue-600 transition-colors" fill="currentColor" viewBox="0 0 20 20">
                  ...
                  <input
                    ...
                    onChange={onChange}
                    required
                    className="w-full pl-12 pr-4 py-3.5 bg-white border-2 border-gray-200 rounded-xl focus:outline-none focus:ring-2 focus:ring-blue-600 focus:border-transparent transition-all text-gray-900 placeholder-gray-400 hover:border-gray-300"
                  />
                </div>
              </div>
              ...
              <div className="group">
                ...
                <div className="relative">
                  ...
                  <input
                    ...
                    onChange={onChange}
                    required
                    className="w-full pl-12 pr-20 py-3.5 bg-white border-2 border-gray-200 rounded-xl focus:outline-none focus:ring-2 focus:ring-blue-600 focus:border-transparent transition-all text-gray-900 placeholder-gray-400 hover:border-gray-300"
                  />
                  <button
                    type="button"
                    onClick={() => setShowPassword(v => !v)}
                    className="absolute inset-y-0 right-0 pr-4 flex items-center text-blue-600 hover:text-blue-700 font-semibold text-sm transition-colors"
                  >
              ...
              <div className="flex items-center justify-between text-sm pt-2">
                ...
                <a href="/admin/reset-password" className="text-blue-600 hover:text-blue-800 font-semibold transition-colors hover:underline">
                  Forgot Password?
                </a>
              </div>
              ...
              <button
                ...
                onClick={onSubmit}
                disabled={loading}
                className="w-full text-white font-bold py-4 rounded-xl transition-all shadow-lg hover:shadow-xl disabled:opacity-70 disabled:cursor-not-allowed transform hover:scale-[1.02] active:scale-[0.98] hover:brightness-110"
              ...
              {message && (
                <div className="bg-red-50 border-l-4 border-red-500 text-red-700 px-4 py-3 rounded-lg flex items-start animate-slideIn">
