    ...
    <form onSubmit={handleSubmit} className="card" style={{marginTop:'1rem'}}>
      ...
      <div className="form-grid" style={{display:'grid',gridTemplateColumns:'1fr 1fr',gap:'1rem'}}>
        ...
        <label className="form-label">Price Monthly
          <input type="number" className="form-field" value={form.priceMonthly} onChange={e=>setForm(f=>({...f,priceMonthly:e.target.value}))} />
        </label>
        <label className="form-label">Price Yearly
          <input type="number" className="form-field" value={form.priceYearly} onChange={e=>setForm(f=>({...f,priceYearly:e.target.value}))} />
        </label>
        <label className="form-label" style={{gridColumn:'1 / -1'}}>Features (comma separated)
          <input className="form-field" value={form.features} onChange={e=>setForm(f=>({...f,features:e.target.value}))} placeholder="feature one, feature two" />
        </label>
              ...
              <div className="table" role="table">
                ...
                {filtered.map(p => (
                  <div className="table-row" role="row" key={p._id}>
                    ...
                    <div role="cell"><span className="badge">{p.recommended? 'Yes':'No'}</span></div>
                    <div role="cell"><span className="badge">{p.published? 'Yes':'No'}</span></div>
